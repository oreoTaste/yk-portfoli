...
function checkSchedule() {
    ...
    if (wsUri2 == "ws://172.31.46.184:9999/portfoli/app/calendar/alert") {
      websocket2 = new WebSocket(wsUri2);
    } else {//http://54.180.194.155/
      wsUri2 = "ws://172.31.46.184:8080/portfoli/app/calendar/alert";
      websocket2 = new WebSocket(wsUri2);
    }
...
function sendMessage() {
  ...
  if (wsUri == "ws://172.31.46.184:9999/portfoli/app/message/alert") {
    websocket = new WebSocket(wsUri);
  } else {
    wsUri = "ws://172.31.46.184:8080/portfoli/app/message/alert";
    websocket = new WebSocket(wsUri);
  }
