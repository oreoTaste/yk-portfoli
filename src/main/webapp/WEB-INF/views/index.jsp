...
function checkSchedule() {
    ...
    if (wsUri2 == "ws://52.79.145.173:9999/portfoli/app/calendar/alert") {
      websocket2 = new WebSocket(wsUri2);
    } else {
      wsUri2 = "ws://52.79.145.173:8080/portfoli/app/calendar/alert";
      websocket2 = new WebSocket(wsUri2);
    }
...
function sendMessage() {
  ...
  if (wsUri == "ws://52.79.145.173:9999/portfoli/app/message/alert") {
    websocket = new WebSocket(wsUri);
  } else {
    wsUri = "ws://52.79.145.173:8080/portfoli/app/message/alert";
    websocket = new WebSocket(wsUri);
  }
